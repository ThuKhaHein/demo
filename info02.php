            ...
            <div class="bg-faded rounded p-5">
              ...
              <div class="mt-3">
                    ...
                    $id = $_GET['id'];
                      ...
                      $row = mysqli_fetch_assoc($res);
                      $photo2 = $row['photo2'];
                     echo "<img class='img-fluid rounded about-heading-img mb-3 mb-lg-0' src='Photo/".$photo2."'> ";
                    ?>
              </div>
...
$id = $_GET['id'];
  ...
  $row = mysqli_fetch_assoc($res);
  $price2 = $row['price2'];
  echo "<a  class='ml-4 mb-2 font-weight-bold btn btn-primary text-white'> $price2 </a>";
}
?>
