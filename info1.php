...
if (isset($_GET['id'])){
  ...
  $sql = "select name1 from gym where id='$id'";
...
$id = $_GET['id'];
  ...
  $sql = "select description1 from gym where id='$id'";
  $res = mysqli_query($con,$sql);
  $row = mysqli_fetch_assoc($res);
  $description1 = $row['description1'];
  echo "<div class='font-weight-bold text-dark mt-2'> $description1</div>";
?>
  </div>
</div>
...
$id = $_GET['id'];
  ...
  $sql = "select photo1 from gym where id='$id'";
  $res = mysqli_query($con,$sql);
  $row = mysqli_fetch_assoc($res);
  $photo1 = $row['photo1'];
...
<!-- Modal start-->
                    ...
                    <form action="send.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="" class="form-control" value="<?php echo "$name1";?>" requied>
                        </div>

                              <?php
                              $id = $_GET['id'];

                                $sql = "select price1 from gym where id='$id'";
                                $res = mysqli_query($con,$sql);
                                $row = mysqli_fetch_assoc($res);
                                $price1 = $row['price1'];
                        ...
                        <div class="form-group">
                            ...
                            <label >Price</label>
                            <input type="text" name="price" id="" class="form-control" value="<?php echo "$price1";}?>" requied>
                        </div>
...
$id = $_GET['id'];
  ...
  $row = mysqli_fetch_assoc($res);
  $price1 = $row['price1'];
  echo "<a  class='ml-5 font-weight-bold btn btn-primary text-white'> $price1 </a>";
}
?>
