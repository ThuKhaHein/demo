            ...
            <div class="bg-faded rounded p-5">
              ...
              <div class="mt-3">
                    ...
                    $id = $_GET['id'];
                      ...
                      $row = mysqli_fetch_assoc($res);
                      $photo1 = $row['photo1'];
                     echo "<img class='img-fluid rounded about-heading-img mb-3 mb-lg-0' src='Photo/".$photo1."'> ";
                    ?>
              </div>
...
$id = $_GET['id'];
  ...
  $row = mysqli_fetch_assoc($res);
  $price1 = $row['price1'];
  echo "<a  class='ml-4 mb-2 font-weight-bold btn btn-primary text-white'> $price1 </a>";
}
?>
