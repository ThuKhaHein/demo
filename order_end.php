      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">ORDER SUCCESSFULLY!</h1>
            
          </div>
            <h2 class="mt-4">Thank you for your placing order!<br>
            <h2>Your Order is estimated to arrive within Two day.</h2>
            <h2>Any Inquiry Question – 09407146127
            Smart Build Your Better Life with <h2>Mr.Shop Myanmar.</h2>
            </h2></h2>
