...
include ('db.php');
  ...
  if (isset($_POST['submit-search'])) {
    ...
    $sql = "SELECT * FROM categories WHERE name LIKE '%$search%' OR price LIKE '%$search%' OR description LIKE '%$search%' OR photo LIKE '%$search%'";
    $result = mysqli_query($con, $sql);
    $queryResult = mysqli_num_rows($result);

    echo "<h5>There are ".$queryResult." result!</h5>";
    ...
    if ($queryResult > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        $id = $row['id'];
          ...
          echo "<div class='row'>";
          echo "<a href='info.php?id=$id'<h5 class='card-title  mb-3 ml-2'>".$name." </h5></a>";
...
include ('db.php');
  ...
  if (isset($_POST['submit-search'])) {
    $search = mysqli_real_escape_string($con, $_POST['search']);
    $sql = "SELECT * FROM gym WHERE name1 LIKE '%$search%' OR price1 LIKE '%$search%' OR description1 LIKE '%$search%' OR photo1 LIKE '%$search%'";
    $result = mysqli_query($con, $sql);
    $queryResult = mysqli_num_rows($result);
    ...
    if ($queryResult > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        $id = $row['id'];
          ...
          echo "<div class='container mt-3'>";
          echo "<div class='row'>";
          echo "<a href='info1.php?id=$id'<h5 class='card-title  mb-3 ml-2'>".$name1." </h5></a>";
...
include ('db.php');
  ...
  if (isset($_POST['submit-search'])) {
    $search = mysqli_real_escape_string($con, $_POST['search']);
    $sql = "SELECT * FROM  kitchen WHERE name2 LIKE '%$search%' OR price2 LIKE '%$search%' OR description2 LIKE '%$search%' OR photo2 LIKE '%$search%'";
    $result = mysqli_query($con, $sql);
    $queryResult = mysqli_num_rows($result);
    ...
    if ($queryResult > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        $id = $row['id'];
          ...
          echo "<div class='container mt-3'>";
          echo "<div class='row'>";
          echo "<a href='info2.php?id=$id'<h5 class='card-title  mb-3 ml-2'>".$name2." </h5></a>";
...
include ('db.php');
  ...
  if (isset($_POST['submit-search'])) {
    $search = mysqli_real_escape_string($con, $_POST['search']);
    $sql = "SELECT * FROM  home WHERE name3 LIKE '%$search%' OR price3 LIKE '%$search%' OR description3 LIKE '%$search%' OR photo3 LIKE '%$search%'";
    $result = mysqli_query($con, $sql);
    $queryResult = mysqli_num_rows($result);
    ...
    if ($queryResult > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        $id = $row['id'];
          ...
          echo "<div class='container mt-3'>";
          echo "<div class='row'>";
          echo "<a href='info3.php?id=$id'<h5 class='card-title  mb-3 ml-2'>".$name3." </h5></a>";
