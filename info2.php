  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3 mr-5">Mr.Shop Myanmar</div>
      </a>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="container">
              <div class="row">
                <h5> <i class="fas fa-phone-square-alt"></i> Call us </h5>
                <h5>-09403257569<br>-09407146127  <i class="fab fa-viber"></i></h5>
                  </div>           
...
if (isset($_GET['id'])){
  ...
  $sql = "select name2 from kitchen where id='$id'";
...
<div class="container sideright mt-2">
  <style>
...
$id = $_GET['id'];
  ...
  $sql = "select description2 from kitchen where id='$id'";
  $res = mysqli_query($con,$sql);
  $row = mysqli_fetch_assoc($res);
  $description2 = $row['description2'];
  echo "<div class='font-weight-bold text-dark mt-2'> $description2</div>";
?>
  </div>
</div>
...
$id = $_GET['id'];
  ...
  $sql = "select photo2 from kitchen where id='$id'";
  $res = mysqli_query($con,$sql);
  $row = mysqli_fetch_assoc($res);
  $photo2 = $row['photo2'];
...
<!-- Modal start-->
                    ...
                    <form action="send.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="" class="form-control" value="<?php echo "$name2";?>" requied>
                        </div>

                              <?php
                              $id = $_GET['id'];

                                $sql = "select price2 from kitchen where id='$id'";
                                $res = mysqli_query($con,$sql);
                                $row = mysqli_fetch_assoc($res);
                                $price2 = $row['price2'];
                        ...
                        <div class="form-group">
                            ...
                            <label >Price</label>
                            <input type="text" name="price" id="" class="form-control" value="<?php echo "$price2";}?>" requied>
                        </div>
...
$id = $_GET['id'];
  ...
  $row = mysqli_fetch_assoc($res);
  $price2 = $row['price2'];
  echo "<a  class='ml-5 font-weight-bold btn btn-primary text-white'> $price2 </a>";
}
?>
<div><a data-toggle='modal' data-target='#facultyModal' class='ml-4 font-weight-bold btn btn-primary text-white'><i class='fas fa-cart-arrow-down mr-2'></i> To Order</a></div>
