...
if (isset($_GET['id'])){
  ...
  $sql = "select name3 from home where id='$id'";
...
$id = $_GET['id'];
  ...
  $sql = "select description3 from home where id='$id'";
  $res = mysqli_query($con,$sql);
  $row = mysqli_fetch_assoc($res);
  $description3 = $row['description3'];
  echo "<div class='font-weight-bold text-dark mt-2'> $description3</div>";
?>
  </div>
</div>
...
$id = $_GET['id'];
  ...
  $sql = "select photo3 from home where id='$id'";
  $res = mysqli_query($con,$sql);
  $row = mysqli_fetch_assoc($res);
  $photo3 = $row['photo3'];
...
<!-- Modal start-->
                    ...
                    <form action="send.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="" class="form-control" value="<?php echo "$name3";?>" requied>
                        </div>

                              <?php
                              $id = $_GET['id'];

                                $sql = "select price3 from home where id='$id'";
                                $res = mysqli_query($con,$sql);
                                $row = mysqli_fetch_assoc($res);
                                $price3 = $row['price3'];
                        ...
                        <div class="form-group">
                            ...
                            <label >Price</label>
                            <input type="text" name="price" id="" class="form-control" value="<?php echo "$price3";}?>" requied>
                        </div>
...
$id = $_GET['id'];
  ...
  $row = mysqli_fetch_assoc($res);
  $price3 = $row['price3'];
 echo "<a  class='ml-5 font-weight-bold btn btn-primary text-white'> $price3 </a>";
}
?>
