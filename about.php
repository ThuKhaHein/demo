...
<div class="">
  ...
  <div id="wrapper">
    ...
    <div class="container">
      <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="img/3.jpg" alt="">
          ...
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              <h2 class="section-heading mb-2">
                ...
                <span class="section-heading-lower font-weight-bold">About Our Online Shop</span>
              </h2>
              <p class="ml-4">Mr.Shop Myanmar was established in January 2016 as a very famous online shopping provider for various products selling hot in Myanmar.</p>

              <h2 class="section-heading mb-2 mt-4">
               
                <span class="section-heading-lower font-weight-bold">Mission</span>
              </h2>
              <p class="ml-4">To be the biggest online shopping provider in Myanmar.</p>

              <h2 class="section-heading mb-2 mt-4">
               
                <span class="section-heading-lower font-weight-bold">Products</span>
              </h2>
              <p class="ml-4">Exercise Equipment , Kitchenware , Home  appliances & Living etc.</p>


              <h2 class="section-heading mb-2 mt-4">
               
                <span class="section-heading-lower font-weight-bold">Why I can say Best Service in Myanmar.</span>
              </h2>
              <p class="ml-4">Best Price , Best Quality and Best Service.
              We deliver to every corner and address in Yangon and other cities throughout Myanmar.
              Our customer service are always happy and eager to hear from you ; 7:00am – 9:00pm for every day.
              Your order will be delivered to the comfort of your home/office within 2 days.
              We are free services of installation for any exercise equipment to YGN.
              You can enjoy payment terms fully cash on delivery and any other online payment.
              </p>

               <h2 class="section-heading mb-2 mt-4">
               
                <span class="section-heading-lower font-weight-bold">Description </span>
              </h2>
              <p>Mr.Shop Myanmar  is the famous online shopping in Myanmar,empowering thousands of sellers to connect with millions of customers.Mr.Shop Myanmar provides immediate and easy access to 60 products in more than 45 catagories.
              </p>

              <h2 class="section-heading mb-2 mt-4">
               
                <span class="section-heading-lower font-weight-bold">Convenient Shopping </span>
              </h2>
              <p class="ml-4">Shopping from your home/office.
              ...
              Your order will be delivered to the comfort of your home/office within 1- 2 days.
                ...
                <span class="section-heading-lower font-weight-bold">Delivery timeline</span>
              </h2>
